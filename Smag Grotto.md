...
Then I will paste this into the note pad so we can cleary read it.  
...
Both the **admin.php** file and **login.php** go to the same login page. Here I will enter the credentails I found in wireshark.  
